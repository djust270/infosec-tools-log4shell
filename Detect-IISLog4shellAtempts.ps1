...
gci "C:\inetpub\logs\LogFiles\W3SVC1" -file -recurse | foreach {Get-Content $_.fullname  | select-string -simplematch 'upper' | out-file C:\temp\log4shellAttempts.txt -append
